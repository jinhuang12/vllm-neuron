...
# This is NOT a green run of this tree. Without the flag can_run_kernel returns
# False, so every NKI seam takes the fallback, and 41 of the 158 items exist to
# rule the fallback out. Expect 41 failed / 117 passed. Use this to exercise the
# fallback path, not to gate. See cpu-development.md section 4 for the three ways
# those 41 report it.
