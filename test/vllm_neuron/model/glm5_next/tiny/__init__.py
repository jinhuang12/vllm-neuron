...
#
# THE DIRECTORY HAS TWO RESIDENTS AND ONE CREATOR. The first adds this marker and
# ``test_tiny_glm5next_forward.py`` beside it, and bears the whole cost of the directory;
# the second later adds ``test_tiny_glm5next_e2e.py`` and bears no part of it. The two
