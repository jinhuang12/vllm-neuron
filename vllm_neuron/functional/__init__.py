...
# Only the entry point is re-exported. Several module-level helpers here share
# names with the MoE block-quant modules at different signatures, so they stay
# reachable at their own module path.
